 ...
 * @author Admin
 */
public class requestID2ndMaxMin {
    public static void main(String[] args) throws SocketException, UnknownHostException, IOException {
        DatagramSocket client = new DatagramSocket();
        //gui chuoi msv
        String requestMessage = ";B21DCCN731;Qp6adKxn";
        ...
        sort(intnums);
        String max = intnums.get(numbers.length - 2).toString();
        String min = intnums.get(1).toString();
